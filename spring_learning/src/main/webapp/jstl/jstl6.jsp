<%@ page language="java" contentType="text/html; charset=UTF-8"
 ...
 <%
   ...
   //jsp에서 생성된 값을 top.jsp에 출력할 경우 atturibute로 셋팅 후 전달가능
   String mid ="hong";
...
<!-- 해당 페이지에 jstl로 변수를 생성하여 값을 top.jsp로 이관되지 않음 -->
<cr:set var="a" value="연습"/>
<!-- 
import : 외부페이지 로드 
url(속성) :외부페이지 경로 및 파일명 
param(import속성 안에만 적용):파라미터 이름으로 해당 페이지에 전달하는 방식(name) 
-->
